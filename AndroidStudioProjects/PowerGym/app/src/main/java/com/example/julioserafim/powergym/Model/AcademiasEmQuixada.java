...
public class AcademiasEmQuixada {
    ...
    public AcademiasEmQuixada(){
        ...
        academias.add(new Academia("World Fitness",-4.964397, -39.025083,"R. Joaquim Gomes da Silva, 2591 - Planalniversitário, Quixadá - Ceará"));
        ...
        academias.add(new Academia("Fisico Academia Feminina",-4.967722, -39.016108,"R. Pres. Vargas, 2090 - Ceto Untro, Quixadá - CE, 63900-000"));
